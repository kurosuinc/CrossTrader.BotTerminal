...
namespace CrossTrader.ViewerExample.ViewModels
{
    public sealed class ExecutionsWindowViewModel : InstrumentsWindowViewModelBase<InstrumentViewModel>
    {
        ...
        //#region RefreshExecutionsCommand

        //private Command _RefreshExecutionsCommand;

        //public ICommand RefreshExecutionsCommand
        //    => _RefreshExecutionsCommand
        //    ?? (_RefreshExecutionsCommand = Command.Create(async () =>
        //    {
        ...
        //                var tasks = items.Select(e => Client.GetExecutionsAsync(e.Id)).ToList();
        //                var Executions = Task.WhenAll(tasks);
        //                try
        //                {
        //                    await Executions;
        //                }
        ...
        //#endregion RefreshExecutionsCommand
